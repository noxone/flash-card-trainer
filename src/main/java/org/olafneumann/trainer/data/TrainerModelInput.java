...
public interface TrainerModelInput {
	/**
	 * Returns the name of the current input. This name will be shown when entering data into the database or when
	 * displaying content for training.
	 * 
	...
	/**
	 * Returns the {@link Font} to be used be the title component when entering data.
	 * 
	...
	/**
	 * Returns the {@link Font} to be used by the text control when entering data into the database.
	 * 
	...
	/**
	 * Returns a pattern that can be used to determine, which part of the entered text can be used as a link
	 * 
	 * @return the pattern
	 */
	 ...
	 * 
	 * @param search
	 *            the pattern part the user clicked at
